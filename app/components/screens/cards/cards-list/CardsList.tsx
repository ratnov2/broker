...
const CardList: FC = () => {
	...
	const { isLoadingCards, userCards } = useCards(currentPage, cardsPerPage)
	const { data } = useUserProfile()

	//Get Current cards on Page
	const indexOfCards = currentPage * cardsPerPage
	const indexOfFirstCard = indexOfCards - cardsPerPage
	const currentCards = userCards?.slice(indexOfFirstCard, indexOfCards)
